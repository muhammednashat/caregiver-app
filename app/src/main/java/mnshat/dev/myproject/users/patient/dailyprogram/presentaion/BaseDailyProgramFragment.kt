    ...
    private fun setText ( numberTask: Int ,title: String?, description: String?){
      if (title?.isEmpty() == true){
        ...
        binding.textDescription.text = Html.fromHtml(
            ...
            "<h2>How it works?</h2>Recognize and question your negative thoughts or worries by asking if they are founded on assumptions or facts, which leads to a more sympathetic and fair judgement on your efforts.<br><br><br>"
