...
//        val textColor = Color.parseColor( "#212121")
        ...
        binding.article.text = Html.fromHtml(
            "<p><b><font color=>كن ثابتًا أمام تقلبات الحياة وتقبل ما لا تستطيع تغييره</font></b></p><p>في رحلة الحياة، نواجه مواقف تجعلنا نشعر بالضعف أو الفقدان. ولكن التحدي يكمن في تقبل ما لا يمكن تغييره والبحث عن السكينة في مواجهة الأقدار. وكما قال الإمام الشافعي(٧٦٧-٨٢٠ م):</p>دع الأيام تفعل ما تشاء<br>وطب نفساً إذا حكم القضاء<br>ولا تجزع لحادثة الليالي<br>فما لحوادث الدنيا بقاء<br><p><b><font color=$headerColor>-إدارة الأفكار السلبية: إعادة النظر في الواقع</font></b></p><p>عندما نشعر بالتوتر أو الحزن فإن الأفكار السلبية تميل إلى السيطرة على عقولنا. وقد نجد أنفسنا نغرق في دوامة من التفكير مثل لن تتحسن الأمور أبدًا أو الأمور دائمًا ضدّي. هنا يأتي دور العلاج السلوكي المعرفي (CBT) في مساعدتنا على إعادة تقييم تلك الأفكار. لذا فكر في هذه الأسئلة:</p>هل هذه الفكرة واقعية؟ هل سبق أن واجهت موقفًا مشابهًا وتحسن؟<br>وكما يقول الشافعي:<br>"+
                    "<p><b><font color=$headerColor></font></b></p>"+
                    "<p><b><font color=$headerColor></font></b></p>"+
                    "<p></p>" +
                    "<p></p>" +
